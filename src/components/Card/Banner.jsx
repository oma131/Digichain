...
const Banner = (props) => {
  return (
    <div className='bg-[#0A071F] w-[1280px] m-auto h-[412px] flex justify-between rounded-lg px-[30px] py-[50px] mt-[42px]'>
        <div className='w-[580px] h-[276px] pl-[39px] flex flex-col justify-between text-left'>
            ...
            <Button style={{ backgroundColor: 'transparent', color: 'white', border: '2px solid #6F4FF2' }}>{props.button}</Button>
        </div>
        <div>
