    ...
    <div className='text-center bg-[#070318] text-white px-[85px] pb-[122px] w-[100%]'>
      ...
      <section>
        <div className="flex justify-center items-center h-screen">
          <div className="bg-[url('./assets/Tech.png')] bg-cover bg-center h-[490px] w-[1290px] flex justify-start items-center">
      ...
      <section className='bg-[#6F4FF2] w-[1280px] h-[369px] mt-[142px] rounded-lg flex flex-col justify-center items-center m-auto'>
